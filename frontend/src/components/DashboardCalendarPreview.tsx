...
function getThemeStyles(isDark: boolean): Record<string, CSSProperties> {
  if (isDark) {
    return {
      card: {
        background: "rgba(255,255,255,0.05)",
    ...
    >
      <style>{`
        ...
        .dashboard-week-scroll::-webkit-scrollbar-thumb {
          background: ${themeStyles.scrollbarThumb as string};
          border-radius: 999px;
        }

        .dashboard-week-scroll::-webkit-scrollbar-thumb:hover {
          background: ${themeStyles.scrollbarThumbHover as string};
        }
      `}</style>
      ...
      <div style={baseStyles.header}>
        <div style={baseStyles.titleWrap}>
          ...
          <p style={{ ...baseStyles.subtitle, ...themeStyles.subtitle }}>{subtitle}</p>
        </div>
        ...
        <div style={baseStyles.weekLabelWrap}>
          ...
          <p style={{ ...baseStyles.timezoneLabel, ...themeStyles.timezoneLabel }}>
        ...
        <>
          <div style={baseStyles.weekHeader}>
            {weekdayLabels.map((label) => (
              <div
                key={label}
                style={{ ...baseStyles.weekHeaderCell, ...themeStyles.weekHeaderCell }}
              >
                {label}
              </div>
            ))}
                ...
                >
                  <div style={baseStyles.dayHeader}>
                    <div style={baseStyles.dayNameWrap}>
                      ...
                      <div style={{ ...baseStyles.dayNumber, ...themeStyles.dayNumber }}>
                        {day.date.getDate()}
                      </div>
                    </div>
                    ...
                    >
                      {today && (
                        <div style={{ ...baseStyles.todayPill, ...themeStyles.todayPill }}>
                          Today
                        </div>
                      )}
                      <div style={{ ...baseStyles.eventCount, ...themeStyles.eventCount }}>
                  ...
                  >
                    {dayEvents.length === 0 ? (
                      <div style={{ ...baseStyles.emptyEventSpace, ...themeStyles.emptyEventSpace }}>
                        No events
                      </div>
                    ) : (
